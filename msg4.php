       ...
       <section id="a" >
		<!-- Banner -->
			<section id="banner" style="color: black" >
                <br>
				<h2><strong>Thankyou</strong>  for Registering for services at SERVICIO!!!</h2>
				<p>We have email your details to service provider, they will reachyou at next moment!!! </p>
				<ul class="actions">
