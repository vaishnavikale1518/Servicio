<?php  
 ...
 {  
        ...
        if ($tcount > 0)  
        {
          header('location:http://localhost/p/miniproject/servicefeedbackform.php');
        }
        else 
        {
    ?>
 ...
 <html>  
      <head>  
           <title>Service Feedback Token</title>  
      ...
      <div class="header">
           ...
           <div class="container" style="width:500px;">
                ...
                <br />  
                 <div class="login-box">
                <h3 align="center">Service Feedback Token Verification</h3>
                <div class="vl"></div>  
                <br />  
                <form method="post">  
                      <div class="textbox">
