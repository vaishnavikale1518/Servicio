		...
		<!-- Banner -->
			<section id="banner">
				<div class="inner">
					<header>
						<h1>Maintenance </h1>
						<p>If I had my life to live over again, I'd be in Maintenance Service .<br />Click Below To  Get Your Service At Your Location. </p>
					</header>
				...
				<!-- Section -->
					<section class="wrapper style2">
						<div class="inner">
                            ...
                            <section>
						<h2>What Maintenance Service Does?</h2>
						<p style="color: black " >
